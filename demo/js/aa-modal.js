;(function(factory) {
    ...
    let defaultSettings = {
        ...
        id: false,
        class: false,
        closeBtnText: '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="2 x="0px" y="0px" viewBox="0 0 212.982 212.982" style="enable-background:new 0 0 212.982 212.982;" xml:space="preserve">\n'+
        ...
        for (let prop in settings) {
            ...
            switch(prop) {
                ...
                case 'id':
                    ...
                    settings[prop] = settings[prop].replaceAll(' ', '');
